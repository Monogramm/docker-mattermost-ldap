...
start() {
    ...
    sed -i \
        ...
        -e "s|sudo mysql -u root --password=\$mysql_pass --execute \"CREATE DATABASE \$db_name;\"|sudo mysql -u root --password=\$mysql_pass -h \$db_host -p 3306 --execute \"CREATE DATABASE \$db_name;\"|g" \
